...
const Blog = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Блог о мебели на заказ | Советы и кейсы от LARANA</title>
        <meta name="description" content="Полезные статьи о кухнях, шкафах-купе и мебели на заказ. Реальные цены, советы по выбору, кейсы клиентов из Екатеринбурга и УрФО." />
        <meta name="keywords" content="блог о мебели, кухни на заказ советы, выбор шкафа купе, мебель екатеринбург" />
          ...
          <div className="bg-primary text-primary-foreground py-12">
            <div className="container mx-auto px-4">
              ...
              <p className="text-xl opacity-90 max-w-3xl">
                Полезные статьи о мебели на заказ, реальные цены, советы по выбору и кейсы наших проектов в Екатеринбурге и УрФО
              </p>
            </div>
          </div>
